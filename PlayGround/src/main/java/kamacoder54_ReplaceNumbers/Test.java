...
public class Test {
    ...
    void testCase1() {
        // The official sample is one string, not a test-case-count input.
        String input = "a1b2c3\n";
        String expected = "anumberbnumbercnumber\n";
    ...
    private void check(String label, String input, String expected) {
        ...
        try (PrintStream output = new PrintStream(captured, true, "UTF-8")) {
            ...
            if ("Not implemented yet".equals(e.getMessage())) {
                System.out.println(label + " unfinished: implement Main.replaceNumbers first."
